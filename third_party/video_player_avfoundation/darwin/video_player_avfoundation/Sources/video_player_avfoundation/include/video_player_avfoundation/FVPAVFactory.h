...
///
/// AVKeyValueStatus is AVF_DEPRECATED_FOR_SWIFT_ONLY (deprecated only when this
/// Objective-C header is imported into Swift). The Objective-C API is still
/// supported and is required for this plugin's older deployment targets, so the
/// Swift-import deprecation diagnostic is suppressed around this single
/// declaration. Local patch; see LOCAL_PATCHES.md at this package's root.
